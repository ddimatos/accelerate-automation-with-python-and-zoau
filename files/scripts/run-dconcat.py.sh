...
python3 /tmp/${DCONCAT} ${SRC_EMP_FILE_NAME} ${ADD_EMP_FILE_NAME} ${NEW_EMP_FILE_NAME}; \
...
chtag -tc IBM-1047 /tmp/${DCONCAT}; \
chmod 755 /tmp/${DCONCAT}; \
python3 /tmp/${DCONCAT} ${SRC_EMP_FILE_NAME} ${ADD_EMP_FILE_NAME}; \
...
chtag -tc IBM-1047 /tmp/${DCONCAT}; \
chmod 755 /tmp/${DCONCAT}; \
python3 /tmp/${DCONCAT} -r ${SRC_EMP_FILE_NAME} ${ADD_EMP_FILE_NAME}; \
